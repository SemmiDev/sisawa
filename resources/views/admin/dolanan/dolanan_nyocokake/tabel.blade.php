            ...
            <tbody>
                @forelse ($listDetail as $detail)
                    <tr>
                        ...
                        <td><img class="max-w-40 max-h-40" src="{{ url('storage/' . $detail['wangsulan1']) }}" /></td>
                        <td><img class="max-w-40 max-h-40" src="{{ url('storage/' . $detail['pitakon2']) }}" /></td>
                        <td><img class="max-w-40 max-h-40" src="{{ url('storage/' . $detail['wangsulan2']) }}" /></td>
                        <td><img class="max-w-40 max-h-40" src="{{ url('storage/' . $detail['pitakon3']) }}" /></td>
                        <td><img class="max-w-40 max-h-40" src="{{ url('storage/' . $detail['wangsulan3']) }}" /></td>
                        <td><img class="max-w-40 max-h-40" src="{{ url('storage/' . $detail['pitakon4']) }}" /></td>
                        <td><img class="max-w-40 max-h-40" src="{{ url('storage/' . $detail['wangsulan4']) }}" /></td>
