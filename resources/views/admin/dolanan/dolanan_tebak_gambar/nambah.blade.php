        ...
        <div class="px-8 py-8">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    ...
                    <select type="text" name="wangsulan" value="{{ old('wangsulan') }}"
                ...
                <div class="mb-5">
                    ...
                    <input type="file" name="gambar3" accept="image/*" value="{{ old('gambar3') }}"
                        class="file-input file-input-bordered file-input-ghost" required />
                </div>
                <div class="mb-5">
                    <label for="gambar4">Gambar 4</label>
                    <input type="file" name="gambar4" accept="image/*" value="{{ old('gambar4') }}"
                        class="file-input file-input-bordered file-input-ghost" required />
                </div>
                <div class="mb-5">
                    <label for="gambar5">Gambar 5</label>
                    <input type="file" name="gambar5" accept="image/*" value="{{ old('gambar5') }}"
                        class="file-input file-input-bordered file-input-ghost" required />
                </div>
                <div class="mb-5">
                    <label for="gambar6">Gambar 6</label>
                    <input type="file" name="gambar6" accept="image/*" value="{{ old('gambar6') }}"
                        class="file-input file-input-bordered file-input-ghost" required />
                </div>
