        ...
        <div class="px-8 py-8">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="wangsulan1" value="{{ old('wangsulan1') }}" required />
                </div>
                <div class="mb-5">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="wangsulan2" value="{{ old('wangsulan2') }}" required />
                </div>
                <div class="mb-5">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="wangsulan3" value="{{ old('wangsulan3') }}" required />
                </div>
                <div class="mb-5">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="wangsulan4" value="{{ old('wangsulan4') }}" required />
                </div>
