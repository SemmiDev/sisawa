        ...
        <div class="px-8 py-8">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    ...
                    <input type="file" name="gambar2" accept="image/*" value="{{ $materi->gambar2 }}"
                        class="file-input file-input-bordered file-input-ghost">
                </div>
                <div class="mb-5">
                    <label for="cerita">Carita</label>
                    <textarea type="text" name="cerita" required>{{ $materi->cerita }}</textarea>
                </div>
                <div class="mb-5">
                    <label for="katrangan">Pitakon</label>
                    <textarea type="text" name="katrangan" required>{{ $materi->katrangan }}</textarea>
                </div>
                <div class="mb-5">
